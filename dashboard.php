...
<body>
    <main class="page-shell">
        ...
        <section class="card">
            <h2>Normalized Data Check</h2>
            <div class="stat-strip">
                <div class="stat">
                    <strong>Users Table Address</strong>
                    <p><?php echo htmlspecialchars($userAddress, ENT_QUOTES, 'UTF-8'); ?></p>
                </div>
                <div class="stat">
                    <strong>Student Info Address</strong>
                    <p><?php echo htmlspecialchars($infoAddress, ENT_QUOTES, 'UTF-8'); ?></p>
                </div>
            </div>
